  ...
  res.render("./inventory/editinventory", {
    ...
    * ************************** */
     ...
     invCont.updateInventory = async(req, res) => {
      let nav = await utilities.getNav();
      const {edit_makename,  edit_modelname, edit_description, edit_imagepath, edit_thumbnailpath, edit_price, edit_year, edit_miles, edit_color, classificationcars, inv_id} = req.body;
      const updateResult = await invModel.updateInventory(edit_makename,  edit_modelname, edit_description, edit_imagepath, edit_thumbnailpath, edit_price, edit_year, edit_miles, edit_color, classificationcars, inv_id)
